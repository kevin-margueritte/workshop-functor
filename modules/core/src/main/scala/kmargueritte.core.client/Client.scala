package kmargueritte.core.http.client

import cats.effect.IO
import kmargueritte.core.database.{CityDAO, RestaurantDAO}
import kmargueritte.core.model.{Behaviour, Restaurant, Weather}
import kmargueritte.core.result.{Error, Ok, Result}
